...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is( 'admin/reports') ? 'active' : '' }}"><a href="{{ session()->has('page.reports')? session('page.reports') : secure_url('admin/reports') }}"><i class="fa fa-users"></i><span>List</span></a></li>
