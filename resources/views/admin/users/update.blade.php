...
<!-- Date picker JS -->
<script src="{{ secure_asset("/bower_components/admin-lte/plugins/datepicker/bootstrap-datepicker.js") }}" type="text/javascript"></script>
@endsection

@section('content')
    <div class='row'>
        @include('admin.sections.flash-message')
        <form id="update_user_form" role="form" method="post" action="{{ secure_url('/admin/doUpdateUser/'. $user['uid']) }}">
            <!-- form start -->
